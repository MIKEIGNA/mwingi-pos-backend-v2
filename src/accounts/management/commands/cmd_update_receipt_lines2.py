...
import os
from accounts.tasks.update_dev_db_tasks import update_receipt_lines_tasks2
...
class Command(BaseCommand):
    ...
    python manage.py cmd_update_receipt_lines2
    ...
    def handle(self, *args, **options):
        ...
        # print(ReceiptLine.objects.all().count())
        ...
        update_receipt_lines_tasks2.delay()
