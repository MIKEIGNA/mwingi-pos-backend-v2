...
class TpLeanModifierIndexView(UserActivityLogMixin, generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = super(TpLeanModifierIndexView, self).get_queryset()
...
class TpModifierIndexView(UserActivityLogMixin, generics.ListCreateAPIView):
    queryset = Modifier.objects.all()
    ...
    def get_queryset(self):
        ...
        queryset = super(TpModifierIndexView, self).get_queryset()
        queryset = queryset.filter(
            profile__user__email=self.request.user
        ).order_by('-id')
...
class TpModifierView(generics.RetrieveUpdateDestroyAPIView):
    queryset = Modifier.objects.all()
    ...
    def get_queryset(self):
        ...
        """
        queryset = super(TpModifierView, self).get_queryset()
        queryset = queryset.filter(
            profile__user__email=self.request.user, 
    ...
    def get_object(self):
        ...
        self.obj = super(TpModifierView, self).get_object()
        return self.obj
    ...
    def get_serializer_context(self):
        context = super(TpModifierView, self).get_serializer_context()
