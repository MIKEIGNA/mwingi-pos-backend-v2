...
from api.utils.permission_helpers.api_view_permissions import CanViewCustomersPermission, IsEmployeeUserPermission
...
class EpLeanCustomerIndexView(generics.ListAPIView):
    ...
    def get_queryset(self):
        ...
        """
        queryset = super(EpLeanCustomerIndexView, self).get_queryset()
...
class EpCustomerIndexView(generics.ListCreateAPIView):
    queryset = Customer.objects.all()
    ...
    def get(self, request, *args, **kwargs):
        ...
        return super(EpCustomerIndexView, self).get(request, *args, **kwargs)
    ...
    def post(self, request, *args, **kwargs):
        ...
        return super(EpCustomerIndexView, self).post(request, *args, **kwargs)
    ...
    def get_queryset(self):
        ...
        Make sure only the owner can view his/her objects
        """
        queryset = super(EpCustomerIndexView, self).get_queryset()
...
class EpCustomerView(generics.RetrieveUpdateDestroyAPIView):
    queryset = Customer.objects.all()
    ...
    def get(self, request, *args, **kwargs):
        ...
        return super(EpCustomerView, self).get(request, *args, **kwargs)
    ...
    def put(self, request, *args, **kwargs):
        ...
        return super(EpCustomerView, self).put(request, *args, **kwargs)
    ...
    def delete(self, request, *args, **kwargs):
        ...
        return super(EpCustomerView, self).delete(request, *args, **kwargs)

    def get_queryset(self):
        """
        Make sure only the owner can view his/her object
        """
        queryset = super(EpCustomerView, self).get_queryset()
