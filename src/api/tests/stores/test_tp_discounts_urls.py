...
class TpDiscountIndexViewTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_view_returns_the_user_discounts_only(self):
        ...
        response = self.client.get(reverse('api:tp_discount_index'))
    ...
    def test_if_view_returns_the_right_content_with_pagination(self):
        ...
        self.assertEqual(
            ...
            'http://testserver/api/discounts/?page=2')
        ...
        response = self.client.get(
                reverse('api:tp_discount_index')  + '?page=2')
        self.assertEqual(response.status_code, 200)

        result = {
            'count': model_num_to_be_created,
            'next': None,
            'previous': 'http://testserver/api/discounts/',
            'results': [
                {
    ...
    def test_view_can_perform_search(self):
        ...
        response = self.client.get(reverse('api:tp_discount_index') + param)
        self.assertEqual(response.status_code, 200)
...
class TpDiscountIndexViewForCreatingTestCase(APITestCase):
    ...
    def test_if_view_can_create_a_discount(self):
        ...
        response = self.client.post(reverse('api:tp_discount_index'), payload)  
    ...
    def test_if_a_discount_cant_be_created_with_an_empty_amount(self):
...
class TpDiscountEditViewForViewingTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_view_can_be_called_successefully(self):
        ...
        response = self.client.get(
            reverse('api:tp_discount_edit_view', 
        ...
        response = self.client.get(
            reverse('api:tp_discount_edit_view', args=(self.discount1.reg_no,))
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_view_can_be_called_successefully3(self):
        ...
        self.discount1.stores.remove(self.store1)
    ...
    def test_view_can_handle_wrong_discount_reg_no(self):
        ...
        response = self.client.get(
            reverse('api:tp_discount_edit_view', args=(4646464,)))
...
class TpDiscountEditViewForEditingTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_view_can_handle_a_wrong_store_reg_no(self):
        ...
        response = self.client.put(
            reverse('api:tp_discount_edit_view', args=(111111111,)), payload)
        self.assertEqual(response.status_code, 404)
...
class TpDiscountEditViewForDeletingTestCase(APITestCase, InitialUserDataMixin):
