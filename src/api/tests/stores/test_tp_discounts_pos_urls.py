...
class TpDiscountPosIndexViewTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_view_returns_the_user_discounts_only(self):
        ...
        with self.assertNumQueries(5):
            response = self.client.get(
                reverse('api:tp_pos_discount_index', args=(self.store1.reg_no,)))
    ...
    def test_if_view_returns_the_right_content_with_pagination(self):
        ...
        self.assertEqual(
            ...
            f'http://testserver/api/pos/discounts/{self.store1.reg_no}/?page=2')
        ...
        response = self.client.get(
                reverse('api:tp_pos_discount_index', args=(self.store1.reg_no,))  + '?page=2')
        self.assertEqual(response.status_code, 200)

        result = {
            'count': model_num_to_be_created,
            'next': None,
            'previous': f'http://testserver/api/pos/discounts/{self.store1.reg_no}/',
            'results': [
                {
    ...
    def test_view_returns_discount_that_belong_to_store_only(self):
        ...
        response = self.client.get(
                reverse('api:tp_pos_discount_index', args=(self.store2.reg_no,)))
        self.assertEqual(response.status_code, 200)
    ...
    def test_view_returns_discount_that_belong_to_user_store_only(self):
        ...
        response = self.client.get(
                reverse('api:tp_pos_discount_index', args=(self.store3.reg_no,)))
        self.assertEqual(response.status_code, 200)
...
class TpDiscountPosIndexViewForCreatingTestCase(APITestCase):
    ...
    def test_if_view_can_create_a_discount(self):
        ...
        with self.assertNumQueries(15):
            response = self.client.post(
                reverse('api:tp_pos_discount_index', 
...
class TpDiscountPosEditViewForViewingTestCase(APITestCase, InitialUserDataMixin, FilterDatesMixin):
    ...
    def test_view_can_be_called_successefully(self):
        ...
        with self.assertNumQueries(4):
            response = self.client.get(
                reverse('api:tp_pos_discount_edit_view', 
    ...
    def test_view_can_handle_wrong_store_reg_no(self):
        ...
        response = self.client.get(
            reverse('api:tp_pos_discount_edit_view', args=(4646464, self.discount1.reg_no)))
        self.assertEqual(response.status_code, 404)

    def test_view_can_handle_wrong_discount_reg_no(self):

        response = self.client.get(
            reverse('api:tp_pos_discount_edit_view', args=(self.store1.reg_no, 4646464,)))
        self.assertEqual(response.status_code, 404)
...
class TpDiscountPosEditViewForEditingTestCase(APITestCase, InitialUserDataMixin):
...
class TpDiscountPosEditViewForDeletingTestCase(APITestCase, InitialUserDataMixin):
