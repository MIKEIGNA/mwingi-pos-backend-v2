...
class ReceiptViewTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_if_view_can_be_called_successefully(self):
        ...
        result = {
            ...
            'tims_success': receipt.tims_success,
            'tims_cu_serial_number': receipt.tims_cu_serial_number,
            'tims_cu_invoice_number': receipt.tims_cu_invoice_number,
            'tims_rel_doc_number': receipt.tims_rel_doc_number,
            'tims_verification_url': receipt.tims_verification_url,
            'store_till_number': receipt.store.till_number, 
            'show_discount_breakdown': receipt.show_discount_breakdown,  
        }
