...
class TpLeanCustomerIndexViewTestCase(APITestCase, InitialUserDataMixin):
    ...
    def setUp(self):
        ...
        * Top User 2 assets:
        ...
        self.customer1 = create_new_customer(self.top_profile1, 'chris')
        self.customer2 = create_new_customer(self.top_profile1, 'alex')
    ...
    def test_view_returns_the_user_customers_only(self):
        ...
        with self.assertNumQueries(5):
            response = self.client.get(reverse('api:tp_customer_index_lean'))
    ...
    def test_if_view_returns_the_right_content_with_pagination(self):
        ...
        self.assertEqual(
            response_data_dict['next'], 'http://testserver/api/customers/lean/?page=2')
        ...
        response = self.client.get(reverse('api:tp_customer_index_lean') + '?page=2')
        self.assertEqual(response.status_code, 200)

        result = {
            'count': model_num_to_be_created, 
            'next': None, 
            'previous': 'http://testserver/api/customers/lean/', 
            'results': [
                {
    ...
    def test_view_can_perform_search(self):
        ...
        for search_term in search_terms:
            ...
            response = self.client.get(reverse('api:tp_customer_index_lean') + param)
            self.assertEqual(response.status_code, 200)
    ...
    def test_view_returns_empty_when_there_are_no_customers(self):
        ...
        response = self.client.get(
            reverse('api:tp_customer_index_lean'), follow=True)
        self.assertEqual(response.status_code, 200)
...
class TpCustomerIndexViewTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_view_returns_the_user_customers_only(self):
        ...
        with self.assertNumQueries(7):
            response = self.client.get(reverse('api:tp_customer_index'))
            self.assertEqual(response.status_code, 200)
    ...
    def test_if_view_returns_the_right_content_with_pagination(self):
        ...
        self.assertEqual(response_data_dict['count'], model_num_to_be_created)
        self.assertEqual(
            response_data_dict['next'], 'http://testserver/api/customers/?page=2')
        self.assertEqual(response_data_dict['previous'], None)
        self.assertEqual(len(response_data_dict['results']), pagination_page_size)
        ...
        # ######### Test second paginated page -  list ######### #
        response = self.client.get(reverse('api:tp_customer_index') + '?page=2')
        self.assertEqual(response.status_code, 200)

        result = {
            'count': model_num_to_be_created, 
            'next': None, 
            'previous': 'http://testserver/api/customers/', 
            'results': [
                {
                    'name': customers[0].name, 
    ...
    def test_view_can_perform_search(self):
        ...
        for search_term in search_terms:
            param = f'?search={search_term}'
            response = self.client.get(reverse('api:tp_customer_index') + param)
            self.assertEqual(response.status_code, 200)
    ...
    def test_view_returns_empty_when_there_are_no_customers(self):
        ...
        response = self.client.get(
            reverse('api:tp_customer_index'), follow=True)
        self.assertEqual(response.status_code, 200)
...
class TpCustomerIndexViewForCreatingTestCase(APITestCase):
    ...
    def test_if_view_can_create_a_customer(self):
        ...
        with self.assertNumQueries(19):
            response = self.client.post(
                reverse('api:tp_customer_index'), payload)
    ...
    def test_if_customer_cant_be_created_when_maintenance_mode_is_on(self):
        ...
        response = self.client.post(reverse('api:tp_customer_index'), payload)
        self.assertEqual(response.status_code, 401)
    ...
    def test_if_a_customer_cant_be_created_with_an_empty_village_name(self):
        ...
        result = {'village_name': ['This field may not be blank.']}
    ...
    def test_if_a_user_cant_have_2_customers_with_the_same_unique_values(self):
        ...
        payload['village_name'] = existing_customer.village_name
    ...
    def test_if_customers_can_have_the_allowed_empty_fields_without_triggering_unique_validator_or_any_other_error(self):
        ...
        existing_customer.village_name = 'p'
...
class TpCustomerViewTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_if_view_can_be_called_successefully(self):
        ...
        with self.assertNumQueries(5):
            response = self.client.get(
                reverse('api:tp_customer_view', args=(self.customer.reg_no,)))
            self.assertEqual(response.status_code, 200)
        ...
        result = {
            ...
            'current_debt': f'{self.customer.current_debt}.00',
            'points': 0,
    ...
    def test_if_view_can_handle_wrong_reg_no(self):
        ...
        response = self.client.get(
            reverse('api:tp_customer_view', args=(4646464,)))
        self.assertEqual(response.status_code, 404)
...
class TpCustomerViewForEditingTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_if_view_can_edit_a_customer(self):
        ...
        with self.assertNumQueries(15):
            response = self.client.put(
                reverse('api:tp_customer_view', args=(self.customer.reg_no,)), payload)
            self.assertEqual(response.status_code, 200)
    ...
    def test_view_can_handle_a_wrong_reg_no(self):
        ...
        response = self.client.put(
            reverse('api:tp_customer_view', args=(111111111,)), payload)
        self.assertEqual(response.status_code, 404)
...
class TpCustomerViewForDeletingTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_view_can_handle_wrong_reg_no(self):
        ...
        response = self.client.delete(
            reverse('api:tp_customer_view', args=(44444,)))
        self.assertEqual(response.status_code, 404)
