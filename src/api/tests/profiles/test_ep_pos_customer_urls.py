...
class EpPosCustomerIndexViewTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_view_returns_the_user_customers_only(self):
        ...
        with self.assertNumQueries(9):
            response = self.client.get(reverse('api:ep_pos_customer_index'))
    ...
    def test_if_view_returns_the_right_content_with_pagination(self):
        ...
        self.assertEqual(
            response_data_dict['next'], 'http://testserver/api/ep/pos/customers/?page=2')
        ...
        response = self.client.get(reverse('api:ep_pos_customer_index') + '?page=2')
        self.assertEqual(response.status_code, 200)

        result = {
            'count': model_num_to_be_created, 
            'next': None, 
            'previous': 'http://testserver/api/ep/pos/customers/', 
            'results': [
                {
    ...
    def test_view_returns_empty_when_there_are_no_customers(self):
        ...
        response = self.client.get(
            reverse('api:ep_pos_customer_index'), follow=True)
        self.assertEqual(response.status_code, 200)
...
class EpPosCustomerIndexViewForCreatingTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_if_view_can_create_a_customer(self):
        ...
        with self.assertNumQueries(21):
            response = self.client.post(
                reverse('api:ep_pos_customer_index'), payload)
    ...
    def test_if_customer_cant_be_created_when_maintenance_mode_is_on(self):
        ...
        response = self.client.post(reverse('api:ep_pos_customer_index'), payload)
        self.assertEqual(response.status_code, 401)
...
class EpPosCustomerViewForEditingTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_if_view_can_edit_a_customer(self):
        ...
        with self.assertNumQueries(17):
            response = self.client.put(
                reverse('api:ep_pos_customer_edit_view', args=(self.customer.reg_no,)), payload)
            self.assertEqual(response.status_code, 200)
    ...
    def test_if_customer_cant_be_edited_when_maintenance_mode_is_on(self):
        ...
        response = self.client.put(
            reverse('api:ep_pos_customer_edit_view', args=(self.customer.reg_no,)), 
            payload
        )
        self.assertEqual(response.status_code, 401)
    ...
    def test_view_can_handle_a_wrong_reg_no(self):
        ...
        response = self.client.put(
            reverse('api:ep_pos_customer_edit_view', args=(111111111,)), payload)
        self.assertEqual(response.status_code, 404)
...
class EpPosCustomerViewForDeletingTestCase(APITestCase, InitialUserDataMixin):
    ...
    def test_view_can_handle_wrong_reg_no(self):
        ...
        response = self.client.delete(
            reverse('api:ep_pos_customer_edit_view', args=(44444,)))
        self.assertEqual(response.status_code, 404)
