...
class MpesaPaymentViewConfirmationForMultipleTeamsTestCase(APITestCase, InitialUserDataMixin):
    def setUp(self):
    ...
    def test_if_MpesaPaymentView_can_confirm_1_month_payment_for_multiple_employees(self):
        
        num_of_employees = 6
        duration = 1
        c2b_data = c2b_return_data()
        
        one_month_price = PriceGeneratorClass.all_accounts_price_calc(
            duration, num_of_employees)
    
        c2b_data['TransAmount'] = one_month_price
        c2b_data['BillRefNumber'] = self.top_profile1.reg_no
        ...
        self.assertEqual(Payment.objects.all().count(), num_of_employees) # Make sure there are no Payment
    ...
    def test_if_MpesaPaymentView_can_confirm_6_month_payment_for_multiple_employees(self):
        
        num_of_employees = 6
        duration = 6
        c2b_data = c2b_return_data()
        
        six_months_price = PriceGeneratorClass.all_accounts_price_calc(
            duration, num_of_employees)
    ...
    def test_if_MpesaPaymentView_can_confirm_12_month_payment_for_multiple_employees(self):
        
        num_of_employees = 6
        duration = 12
        c2b_data = c2b_return_data()
        
        one_year_price = PriceGeneratorClass.all_accounts_price_calc(
            duration, num_of_employees)
    ...
    def test_if_MpesaPaymentView_wont_confirm_a_wrong_amount_for_multiple_employees(self):
    ...
    def test_if_MpesaPaymentView_wont_confirm_duplicate_payment_for_multiple_employees(self):
    ...
    # We dont neeed to test 
    
    # * test_if_MpesaPaymentView_wont_confirm_wrong_reg_no
    # * test_if_MpesaPaymentView_confirmation_will_return_403_if_given_wrong_data
    
    # since we tested it in the MpesaPaymentViewForConfirmationForSingleTeamsTest class 
    # and they use the same arguments
    
  
class MpesaPaymentViewValidationForMultipleTeamsTestCase(APITestCase, InitialUserDataMixin):
    def setUp(self):
    ...
    def test_if_MpesaPaymentView_can_validate_1_month_payment_for_multiple_employees(self):
    ...
    def test_if_MpesaPaymentView_can_validate_6_month_payment_for_multiple_employees(self):
    ...
    def test_if_MpesaPaymentView_wont_validate_a_wrong_amount_for_multiple_employees(self):
    ...
    def test_if_MpesaPaymentView_wont_validate_duplicate_payment_for_multiple_employees(self):
    ...
    # * test_if_MpesaPaymentView_wont_validate_wrong_reg_no
    # * test_if_MpesaPaymentView_validation_will_return_403_if_given_wrong_data

    # since we tested it in the MpesaPaymentViewForValidationForSingleTeamsTest class 
    # and they use the same arguments
